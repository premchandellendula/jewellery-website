...
const StateDropDown = ({label, onChange}) => {
  return (
    <div className="flex flex-col mt-2">
        <label className='mb-2 text-base'>{label}</label>
        <div class="relative">
            <select class="block w-full px-2 py-2 bg-blue-50 text-gray-700 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:border-blue-600 focus:border-2" onChange={onChange}>
